...
import { gameData, characters } from "./main.js";
    ...
    handleJumpAnimation(direction) {
        ...
        switch (this.jumpPhase) {
            case "start":
                ...
                if (this.currentAnimation !== "jumping_start" ||
            ...
            case "ascending":
                ...
                if (this.currentAnimation !== "jumping_ascending" ||
            ...
            case "falling":
                ...
                if (this.currentAnimation !== "jumping_falling" ||
            ...
            case "landing":
                ...
                const landingFrameKey = `${this.charName}_jumping_${direction}_${(landingFrame + 6)
                    .toString()
                    .padStart(3, "0")}`;
                if (this.currentAnimation !== "jumping_landing" ||
