...
export class Platform extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y, width = 200, height = 20) {
        ...
        this.body.setVelocity(0, 0); // Stop any vertical movement
    ...
    static createPlatformSequence(scene, startX, startY, count, spacing = 150, heightVariation = 50, existingPlatforms = [], portalCollisionCheck) {
        const platforms = [];
        for (let i = 0; i < count; i++) {
            ...
            while ((Platform.checkPlatformCollision(x, y, platformWidth, platformHeight, [
                ...existingPlatforms,
                ...platforms,
            ]) ||
    ...
    static createFloatingPlatforms(scene, startX, baseY, count, spacing = 200, existingPlatforms = [], portalCollisionCheck) {
        const platforms = [];
        for (let i = 0; i < count; i++) {
            let x = startX + i * spacing;
            // Ensure platforms are never above Y=100 to avoid UI overlap
