...
export class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add
            .text(600, 350, `You played as: ${characterName}`, {
            fontSize: "24px",
            fill: "#ecf0f1",
        })
            .setOrigin(0.5);
        ...
        this.add
            .text(600, 400, "Better luck next time!", {
            fontSize: "18px",
            fill: "#bdc3c7",
        })
            .setOrigin(0.5);
        ...
        // Instructions
        this.add
            .text(600, 650, 'Click "Play Again" to return to character selection', {
            fontSize: "14px",
            fill: "#95a5a6",
        })
            .setOrigin(0.5);
