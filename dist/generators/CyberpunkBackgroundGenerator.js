...
export class CyberpunkBackgroundGenerator {
    ...
    static addStars(graphics, width, height) {
    ...
    static createCitySkyline(graphics, width, height) {
        ...
        buildings.forEach((building) => {
            ...
            graphics.fillRect(building.x, groundY - building.height, building.width, building.height);
    ...
    static addBuildingWindows(graphics, building, groundY) {
        const windowSize = 8;
        const spacing = 12;
        for (let x = building.x + 4; x < building.x + building.width - 4; x += spacing) {
            for (let y = groundY - building.height + 10; y < groundY - 10; y += spacing) {
    ...
    static addNeonLights(graphics, width, height) {
    ...
    static addAtmosphericEffects(graphics, width, height) {
        // Fog/smoke effects
...
//# sourceMappingURL=CyberpunkBackgroundGenerator.js.map