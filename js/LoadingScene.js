class LoadingScene extends Phaser.Scene {
    ...
    createLoadingUI() {
        ...
        // Loading text
        this.loadingText = this.add.text(600, 350, 'Loading Assets...', {
            fontSize: '24px',
            fill: '#ffffff',
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        this.progressBarBg = this.add.rectangle(600, 450, 400, 20, 0x333333)
            .setOrigin(0.5);

        // Progress bar
        this.progressBar = this.add.rectangle(400, 450, 0, 20, 0x00ffff)
            .setOrigin(0, 0.5);

        // Progress text
        this.progressText = this.add.text(600, 500, '0%', {
            fontSize: '18px',
            fill: '#ffffff',
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        // Loading animation
        this.loadingDots = this.add.text(600, 550, '...', {
            fontSize: '20px',
            fill: '#00ffff'
        }).setOrigin(0.5);
    ...
    loadMapData() {
        ...
        // Load modified map
        this.load.json('modifiedMap', 'maps/modified.json');
    }
