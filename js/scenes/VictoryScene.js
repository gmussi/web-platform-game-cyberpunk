class VictoryScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(600, 280, `Congratulations, ${characterName}!`, {
            fontSize: '28px',
            fill: '#ffffff',
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        // Success message
        this.add.text(600, 340, 'You have successfully reached the portal!', {
            fontSize: '20px',
            fill: '#00ff88'
        }).setOrigin(0.5);

        // Portal reached message
        this.add.text(600, 380, 'Mission Complete', {
            fontSize: '24px',
            fill: '#ffffff',
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        this.add.text(600, 480, 'Play Again', {
            fontSize: '20px',
            fill: '#000000',
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        // Instructions
        this.add.text(600, 580, 'Click "Play Again" to return to character selection', {
            fontSize: '14px',
            fill: '#888888'
        }).setOrigin(0.5);
