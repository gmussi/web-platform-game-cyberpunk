class GameScene extends Phaser.Scene {
    ...
    loadTileDataFromMap() {
        ...
        if (this.mapData && this.mapData.tiles && Array.isArray(this.mapData.tiles)) {
            ...
            // Tile data loaded from map successfully
            
            // Debug: Check specific tile (120, 13) - removed for production
    ...
    createEnemies() {
        ...
        // Debug: Log player physics body info - removed for production
        if (this.player) {
            // Debug info removed
        }
    }
